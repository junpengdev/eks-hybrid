...
var _ = Describe("Hybrid Nodes", func() {
	When("using peered VPC", func() {
		...
		When("using ec2 instance as hybrid nodes", func() {
			It("runs node monitoring agent tests", Ordered, func(ctx context.Context) {
			...
			It("runs kube state metrics tests", Ordered, func(ctx context.Context) {
				It("uses non Bottlerocket OS", func(ctx context.Context) {
			...
			It("runs metrics server tests", Ordered, func(ctx context.Context) {
				It("uses non Bottlerocket OS", func(ctx context.Context) {
			...
			It("runs prometheus node exporter tests", Ordered, func(ctx context.Context) {
				It("uses non Bottlerocket OS", func(ctx context.Context) {
			...
			It("runs nvidia device plugin tests", Ordered, func(ctx context.Context) {
				It("uses non Bottlerocket OS", func(ctx context.Context) {
			...
			It("runs cert manager and AWS PCA issuer tests", Ordered, func(ctx context.Context) {
				It("uses non Bottlerocket OS", func(ctx context.Context) {
